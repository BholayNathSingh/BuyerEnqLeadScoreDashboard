...
## Feature significance for categorical features
        def pvalue_cat_features():
            ...
            results_df = results_df[['#', 'Feature', 'P-Value']]
            ...
            # Display full table without shrinking, hide index, and ensure no empty rows
...
## feature significance for numerical features
        def pvalue_num_features():
            ...
            # Add serial numbers
            anova_results_df['#'] = range(1, len(anova_results_df) + 1)
            
            # Reorder columns to show serial number first
            anova_results_df = anova_results_df[['#', 'Feature', 'P-Value']]
